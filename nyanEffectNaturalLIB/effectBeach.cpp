...
BOOL CEffectBeach::SetParam(LPVOID lpEffect, int paraKosuu, int* paraPtr,int layer)
{
	...
	if (paraKosuu<8) para[7] = 30;	//周期1
	if (paraKosuu<9) para[8] = 43;	//周期2
	if (paraKosuu<10) para[9] = 300;	//移動幅1
	if (paraKosuu<11) para[10] = 250;	//移動幅2
	if (paraKosuu<12) para[11] = 100;	//波幅1
	if (paraKosuu<13) para[12] = 100;	//波幅2
	if (paraKosuu<14) para[13] = 700;	//右側限界
	if (paraKosuu<15) para[14] = 100;	//パースパラ
