...
#include "effectchange.h"



CEffectChange::CEffectChange(CAllEffect* lpAll) : CCommonEffect(lpAll)
{
}


CEffectChange::~CEffectChange()
{
}


void CEffectChange::End(void)
{
}


BOOL CEffectChange::SetParam(LPVOID lpEffect, int paraKosuu, int* paraPtr,int layer)
{
...
BOOL CEffectChange::CountIsMax(LPVOID lpEffect,int layer)
{
...
void CEffectChange::BeginPrint(LPVOID para,int layer)
{
}


void CEffectChange::Init(LPVOID para,int layer)
{
}

void CEffectChange::Calcu(LPVOID lpEffect,int layer)
{
}

void CEffectChange::Print(LPVOID lpEffect,int layer)
{
	EFFECT* lp = (EFFECT*)lpEffect;
...
BOOL CEffectChange::CheckNeedPicPrint(LPVOID lpEffect,int layer)
{
