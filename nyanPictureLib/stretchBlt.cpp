...
void CStretchBlt::End(void)
{
}


void CStretchBlt::Print(POINT dstPoint,POINT srcPoint,SIZE dstSize,SIZE srcSize,LPVOID picData,LPVOID maskData,SIZE picSize,BOOL bTransFlag,int transPercent)
{
