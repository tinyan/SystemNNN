...
CMiniGameSlide16::~CMiniGameSlide16()
{
	End();
}


void CMiniGameSlide16::End(void)
{
}

int CMiniGameSlide16::Init(void)
{
	for (int j=0;j<4;j++)
	{
		for (int i=0;i<4;i++)
...
int CMiniGameSlide16::Calcu(void)
{
	if (m_clearFlag)
	{
		return -1;
...
int CMiniGameSlide16::Print(void)
{
	if (m_clearFlag)
	{
		CAreaControl::SetNextAllPrint();
...
int CMiniGameSlide16::SearchSlideOkPanel(int x,int y)
{
	for (int i=0;i<8;i++)
	{
...
void CMiniGameSlide16::SlidePanel(int n)
{
