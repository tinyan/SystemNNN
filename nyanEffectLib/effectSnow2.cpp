...
CEffectSnow2::CEffectSnow2(CAllEffect* lpAll) : CCommonEffect(lpAll)
{
...
CEffectSnow2::~CEffectSnow2()
{
	End();
}


void CEffectSnow2::End(void)
{
	ENDDELETECLASS(m_snowPic);
}

void CEffectSnow2::InitParameter(LPVOID lpEffect, int layer)
{
	int para[3];
...
BOOL CEffectSnow2::SetParam(LPVOID lpEffect, int paraKosuu, int* paraPtr,int layer)
{
	EFFECT* lp = (EFFECT*)lpEffect;
...
BOOL CEffectSnow2::CountIsMax(LPVOID lpEffect,int layer)
{
	return FALSE;
	//nothing to do
}

void CEffectSnow2::BeginPrint(LPVOID para,int layer)
{
	m_snowCalcuedFlag = FALSE;
}


void CEffectSnow2::Init(LPVOID para,int layer)
{
...
void CEffectSnow2::Calcu(LPVOID lpEffect,int layer)
{
}

void CEffectSnow2::Print(LPVOID lpEffect,int layer)
{
...
void CEffectSnow2::InitSnow(void)
{
	int i,j;
...
void CEffectSnow2::SetNewSnow(int n)
{
	int r = rand() % 25600;
...
void CEffectSnow2::CalcuSnow(void)
{
...
void CEffectSnow2::CalcuSnowXY(int n)
{
	int x = m_snow[n].x;
	int y = m_snow[n].y;
